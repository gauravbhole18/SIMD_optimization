 ...
 * File: _coder_predict_sine_mex.c
 *
...
void mexFunction(int32_T nlhs, mxArray *plhs[], int32_T nrhs,
                 const mxArray *prhs[])
{
  mexAtExit(&predict_sine_atexit);
  /* Module initialization. */
  predict_sine_initialize();
  /* Dispatch the entry-point. */
  unsafe_predict_sine_mexFunction(nlhs, plhs, nrhs, prhs);
  /* Module termination. */
                                     ...
                                     int32_T nrhs, const mxArray *prhs[4])
{
  ...
  b_prhs[2] = prhs[2];
  b_prhs[3] = prhs[3];
  predict_sine_api(b_prhs, &outputs);
  /* Copy over outputs to the caller. */
  emlrtReturnArrays(1, &plhs[0], &outputs);
}

/*
 * File trailer for _coder_predict_sine_mex.c
 *
 * [EOF]
 */
